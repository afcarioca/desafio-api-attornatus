...
public record DadosConsultaEnderecoDTO(UUID id, String logradouro, String cep, String numero, String cidade,
	...
	public DadosConsultaEnderecoDTO(EnderecoModel endereco) {
